        ...
        <section className="max-w-4xl mx-auto py-12 px-4 flex flex-col gap-8">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            {products.map((product) => {
              return (
                <div key={product.id} className="flex flex-col justify-between rounded-md shadow-lg border border-opacity-10 border-gray-800">
                  ...
                  <div className="p-4 flex flex-col gap-4">
                    <div className="px-6 py-2 text-center font-bold capitalize bg-blue-600 rounded-full text-white">{product.category}</div>
